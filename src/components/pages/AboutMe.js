...
const AboutMe = () => (
  <div>
    ...
    During the course we learned creating beautiful, usable, professional websites using best practice accessibility and the latest W3 web standard guidelines resulting in semantic and user friendly HTML and CSS websites. We also learned latest front end and back end technologies which helped us to build real time applications.All my sites are lovingly hand coded.
